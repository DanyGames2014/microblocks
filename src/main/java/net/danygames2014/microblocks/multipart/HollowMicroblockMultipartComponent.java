...
public class HollowMicroblockMultipartComponent extends MicroblockMultipartComponent{
    ...
    public ObjectArrayList<Box> getBoundingBoxes() {
        ...
        boxes.add(BoxUtil.rotate(box_top, DirectionUtil.faceSlotToDirection(slot)).offset(x, y, z));
        boxes.add(BoxUtil.rotate(box_bottom, DirectionUtil.faceSlotToDirection(slot)).offset(x, y, z));
        boxes.add(BoxUtil.rotate(box_left, DirectionUtil.faceSlotToDirection(slot)).offset(x, y, z));
        boxes.add(BoxUtil.rotate(box_right, DirectionUtil.faceSlotToDirection(slot)).offset(x, y, z));

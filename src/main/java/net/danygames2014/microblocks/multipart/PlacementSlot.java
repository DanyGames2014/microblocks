...
public enum PlacementSlot {
    ...
    // 7
    CORNER_BOT_NEG_X_NEG_Z(7), //7
    CORNER_TOP_NEG_X_NEG_Z(8), //8
    CORNER_BOT_NEG_X_POS_Z(9), //9
    CORNER_TOP_NEG_X_POS_Z(10), //10
    CORNER_BOT_POS_X_NEG_Z(11), //11
    CORNER_TOP_POS_X_NEG_Z(12), //12
    CORNER_BOT_POS_X_POS_Z(13), //13
    CORNER_TOP_POS_X_POS_Z(14), //14

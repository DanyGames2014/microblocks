...
public class EdgeGridRenderer extends GridRenderer{
    public static EdgeGridRenderer INSTANCE = new EdgeGridRenderer();
    public void render(PlayerEntity player, int blockX, int blockY, int blockZ, Vec3d hit, Direction face, double size, float tickDelta){
        ...
        GL11.glVertex3d(-size, 0,-0.5);
        GL11.glVertex3d(-size, 0, 0.5);

        GL11.glVertex3d(-0.5, 0, size);
        GL11.glVertex3d( 0.5, 0, size);
